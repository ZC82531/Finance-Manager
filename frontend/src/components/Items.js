...
function Items(props) {
  ...
  return (
    <div className='flex bg-white rounded-2xl font-mont w-full p-5 flex-col smr gap-8 '>
        <div className='text-black flex  justify-between smr  '>
        <p className='text-black font-bold text-2xl justify-between font-mont '>$ {exp.amount}</p>
        ...
        <div className='grid grid-flow-col  justify-between smr  '>
            <div className='text-black text-center mt-1 category w-fit p-1 pl-2 pr-2  h-fit  rounded-full border-2 text-sm '><p>{exp.category}</p></div>
